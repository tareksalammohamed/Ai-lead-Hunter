...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'settings', label: 'مركز الإعدادات الموحد', icon: Settings, group: 'الإعدادات' },
  { key: 'ai_providers', label: 'مزودو AI والمفاتيح', icon: Cpu, group: 'الذكاء الاصطناعي' },
  { key: 'ai_models', label: 'توجيه النماذج', icon: Brain, group: 'الذكاء الاصطناعي' },
  { key: 'ai_reliability', label: 'اعتمادية AI والتكاملات', icon: ShieldCheck, group: 'الذكاء الاصطناعي' },
  { key: 'search_providers', label: 'مزودو البحث ومفاتيحهم', icon: Search, group: 'مصادر البحث' },
  { key: 'source_connectors', label: 'موصلات المصادر', icon: Plug, group: 'مصادر البحث' },
  { key: 'research_engine', label: 'محرك البحث', icon: Activity, group: 'محركات البيانات' },
  { key: 'lead_scoring', label: 'تقييم العملاء', icon: Star, group: 'محركات البيانات' },
  { key: 'phone_rules', label: 'قواعد الهاتف', icon: Phone, group: 'محركات البيانات' },
  { key: 'duplicate_engine', label: 'محرك التكرار', icon: Copy, group: 'محركات البيانات' },
  { key: 'usage_limits', label: 'الاستخدام والحدود', icon: Gauge, group: 'إدارة النظام' },
  { key: 'feature_flags', label: 'ميزات النظام', icon: Flag, group: 'إدارة النظام' },
  { key: 'security', label: 'مركز الأمان', icon: Shield, group: 'إدارة النظام' },
  { key: 'notifications', label: 'الإشعارات', icon: Bell, group: 'إدارة النظام' },
